...
export default function EditForm({ openModal, closeModal, card }) {
    ...
    const fetchCardDoors = async (cardId) => {
        setLoading(true)
        try {
            const response = await axios.get(route('cards.doors', cardId))
            setData('door_ids', response.data)
        } catch (error) {
            toast.error("Failed to load card's door permissions")
        } finally {
            setLoading(false)
        }
    }
            ...
            <div className="p-4 sm:p-6">
                ...
                <form onSubmit={onSubmit} className="space-y-5">
                    ...
                    <div className="space-y-2">
                        <label htmlFor="edit-rfid_uid" className="block text-sm font-medium text-gray-700">
