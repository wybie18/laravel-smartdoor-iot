...
export default function DeleteForm({ openModal, closeModal, door }) {
    ...
    const handleDelete = (e) => {
        ...
        destroy(route("doors.destroy", door.id), {
            preserveScroll: true,
            onSuccess: () => {
            ...
            onError: (errors) => {
                toast.error("An error occurred while deleting the door.")
        ...
        <Modal show={openModal} onClose={closeModal}>
            <div className="p-4 sm:p-6">
                <div className="flex items-center justify-between border-b border-gray-200 pb-3 mb-5">
                    <h2 className="text-lg font-medium text-gray-900">Delete Door</h2>
                    <button
                        type="button"
                        onClick={closeModal}
                    ...
                    <div className="flex flex-col items-center text-center sm:flex-row sm:text-left sm:items-start gap-4">
                        ...
                        <div className="text-sm text-gray-600">
                            <p className="mb-2">
                                ...
                                <span className="font-semibold text-gray-800 block sm:inline sm:ml-1">{door?.name}</span>?
                            </p>
                            <p className="text-red-600 font-medium">This action cannot be undone. All access records associated with this door will be permanently removed.</p>
                        </div>
                    </div>
